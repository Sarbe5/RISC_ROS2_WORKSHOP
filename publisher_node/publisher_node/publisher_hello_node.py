...
class PublisherHelloNode(Node):
    def __init__(self):
        ...
        # creates a timer that calls the timer_callback function
    ...
    def timer_callback(self):
        msg = String()
        # creates the message to be published #fstring is used to format the
        # string with the value of i
...
def main(args=None):
    ...
    # creates an instance of the PublisherHelloNode class
    publisher_hello_node = PublisherHelloNode()
    # keeps the node running and processing callbacks
    rclpy.spin(publisher_hello_node)
