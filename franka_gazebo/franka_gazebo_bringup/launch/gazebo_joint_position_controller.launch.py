...
# World path
    pick_place_world = os.path.join(
        get_package_share_directory('franka_gazebo_bringup'),
        'world',
        'pick_place.sdf'
    )

# Gazebo Sim with pick_place world
    # Gazebo Sim
    ...
    gazebo_world = IncludeLaunchDescription(
        ...
        launch_arguments={'gz_args': [pick_place_world, ' -r']}.items(),
    )
    ...
    # Load gripper effort controller instead of the default gripper controller
    ...
    # Joint state publisher (simplified since we're not using the default gripper launch)
    ...
    return LaunchDescription([
        ...
        RegisterEventHandler(
            event_handler=OnProcessExit(
                target_action=joint_position_controller,
